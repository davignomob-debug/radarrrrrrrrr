...
-- // LÓGICA DE TELEPORTE MAPA TODO (SUBSTITUINDO PROMPT SHOWN)
...
RunService.Heartbeat:Connect(function()
    ...
    -- Varre todos os prompts do jogo para achar o alvo independente da distância
            ...
            if nomeObj:find(AlvoSelecionado) or textoPrompt:find(AlvoSelecionado) then
                ...
                pcall(function()
                    ...
                    if hrp and targetPart then
                        ...
                        -- Força a ativação de longe (Bypass)
